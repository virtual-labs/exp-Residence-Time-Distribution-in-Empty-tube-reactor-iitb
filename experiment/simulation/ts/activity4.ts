...
function activity4() {
    ...
    tau_2 = (vol_of_reactor * 60) / flow_rate_2;
...
<table  class="table" >
    ...
    let formula = `
    <p>Volume of Reactor, V (cm<sup>3</sup>) = 1473</p>
...
function act5_verify_obtable_1() {
    ...
    let val8: HTMLInputElement = <HTMLInputElement>document.getElementById("mt-8");
  ...
  function act5_verify_obtable_11() {
    ...
    let val8: HTMLInputElement = <HTMLInputElement>document.getElementById("mt-18");
