...
var obt1_first_value_verfied: boolean = false;
...
function act3_verify_obtable_1() {
  let val1: HTMLInputElement = <HTMLInputElement>document.getElementById("obt1-r1");
...
function act3_verify_obtable_2() {
  let val1: HTMLInputElement = <HTMLInputElement>document.getElementById("obt1-r2");
  ...
  pp.showdescription(
    '<p style="background-color: #f4ccccff; border-radius: 10px; border: black; padding: 5%; font-weight: 500; font-size: calc(0.8vw + 8px);">Show the full Table with flow rate = 200 cm<sup>3</sup>/min</p>', 3);
...
function complete_obtab_1() {
  ...
  pp.showdescription(
   '<p style="background-color: #f4ccccff; border-radius: 10px; border: black; padding: 5%; font-weight: 500; font-size: calc(0.8vw + 8px);">Show the full Table with flow rate = 400 cm<sup>3</sup>/min</p>', 3);
...
function complete_obtab_2() {
  ...
  pp.showdescription(
    '<p style="background-color: #f4ccccff; border-radius: 10px; border: black; padding: 5%; font-weight: 500; font-size: calc(0.8vw + 8px);">Let\'s start with calculations.</p>', 3);
